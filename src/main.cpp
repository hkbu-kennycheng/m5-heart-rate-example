...
m5::unit::UnitMAX30100 unit;  // *2 Instance of the unit
m5::unit::max30100::Data data;
...
void update_task(void*)
{
    for (;;) {
        ...
        if (unit.updated()) {
            ...
            M5_LOGI("ir:%d red:%d", data.ir(), data.red());
            M5.Display.setCursor(10, 10);
            M5.Display.printf("ir:%d red:%d", data.ir(), data.red());
        }
